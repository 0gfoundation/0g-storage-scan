...
var (
	...
	rewardOldFilterer  *OnePoolRewardOldFilterer
...
func init() {
	...
	rewardOldFilterer, _ = NewOnePoolRewardOldFilterer(common.HexToAddress(""), nil)
...
func DummyRewardOldFilterer() *OnePoolRewardOldFilterer {
	return rewardOldFilterer
}
